...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.SkySaverKey] = _dbContainer.ConnectionString;
    ...
    {
        var options = new DbContextOptionsBuilder<SkySaverDbContext>()
            .UseNpgsql(connectionString)
            .Options;
        var context = new SkySaverDbContext(options, null, null, null);
    ...
    private static TestcontainerDatabase DbSetup()
    {
        return new TestcontainersBuilder<PostgreSqlTestcontainer>()
            ...
            .WithName($"IntegrationTesting_SkySaver_{Guid.NewGuid()}")
