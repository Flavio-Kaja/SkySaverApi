...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<SkySaverDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<SkySaverDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<SkySaverDbContext, Task<T>> action)
