...
public sealed class SkySaverDbContext : IdentityDbContext<User, Role, Guid>
{
    ...
    public SkySaverDbContext(
        DbContextOptions<SkySaverDbContext> options, ICurrentUserService currentUserService, IMediator mediator, IDateTimeProvider dateTimeProvider) : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        */
        ...
        modelBuilder.ApplyConfiguration(new UserPurchaseConfiguration());
        modelBuilder.ApplyConfiguration(new ScavengerHuntConfiguration());
